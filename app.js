    ...
    categories: [
      {
        ...
        icon: "💰",
        items: [
          { label: "타입", type: "select", options: ["전세", "월세", "반전세"] },
          { label: "금액", type: "input", placeholder: "금액" },
          { label: "관리비", type: "input", placeholder: "금액" }
        ]
      },
      {
        name: "입주 조건",
    ...
    categories: [
      {
        ...
        items: [
          ...
          "등기부등본 을구 (근저당권/대출 금액 확인)",
          "건축물대장 확인 (불법건축물/무단증축 여부)",
          "토지이용계획 확인",
      ...
      },
      {
        ...
        icon: "🛡️",
        items: [
          "전세보증보험 가입 가능 여부 (HUG/SGI/HF)",
          "근저당+보증금 합계 < 시세 70~80% 확인",
          "전세가율 확인 (깡통전세 위험)",
          "확정일자 부여 가능 여부"
        ]
      },
      {
        ...
        icon: "✍️",
        items: [
          "대출 안 나올 경우 계약 해지 및 계약금 반환 특약",
          "보증보험 가입 불가 시 계약 해지 및 계약금 반환 특약",
          "계약~잔금까지 추가 근저당 설정 금지 특약",
          "입주 전 하자 수리 임대인 부담 특약",
          "기타 특약사항 협의 및 기재"
        ]
      },
      {
